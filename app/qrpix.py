...
class Payload(): # criando objeto payload
    def __init__(self, nome, chavepix, valor, cidade, txtId, diretorio=''):
        ...
        # versão do payload QRCPS-MPM, fixo em “01” 0002-01
        self.payloadFormat = '000201'
        # valor da transação é opcional
    ...
    def gerarCrc16(self, payload):
        ...
        self.crc16Code_formatado = str(self.crc16Code).replace(
            '0x', '').upper().zfill(4)  # upper é dispensável
...
# ao digitar 0, o cliente que digita o valor
